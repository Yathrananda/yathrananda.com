...
const PackagesSectionType1: React.FC<PackagesSectionType1Props> = ({
  title = "Most Trending Travel Packages",
            ...
            >
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-12 pr-4 py-3 bg-card border border-border rounded-full outline-none focus:ring-2 focus:ring-black focus:border-transparent text-sm transition-all duration-200 ease-out text-card-foreground placeholder:text-muted-foreground shadow-sm hover:shadow-md"
          ...
          {isLoading ? (
                  ...
                  >
                    <Link href={`/packages/${pkg.id}`} className="block">
                      <article className="bg-card border border-border rounded-2xl overflow-hidden shadow-lg transition-all duration-300 ease-out group-hover:shadow-xl relative">
                        <div
                          className={`relative ${getImageHeightClass()} overflow-hidden`}
                        >
                          <Image
            ...
            >
              ...
              <p className="text-muted-foreground mb-6 max-w-md mx-auto">
                We couldn't find any packages matching "{searchQuery}". Try
                searching for a different destination or clear your search.
              </p>
              <button
