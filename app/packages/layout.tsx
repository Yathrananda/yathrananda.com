...
export const metadata: Metadata = {
  title: "All Packages - Yathrananda | Global Travel Experiences",
  description:
    "Explore Yathrananda's handpicked tour packages offering unforgettable experiences worldwide. From European adventures to Asian explorations, discover the world with us.",
  keywords:
    "all packages, global travel packages, Europe tours, Asia packages, world tourism, luxury travel, adventure tours, cultural experiences, holiday packages, international destinations",
  openGraph: {
