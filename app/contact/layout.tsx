...
export const metadata: Metadata = {
  ...
  description:
    "Contact Yathrananda's travel experts for personalized trip planning. Call +1 (555) 123-4567, email hello@Yathrananda.com, or fill out our contact form. Free consultation available.",
  keywords:
