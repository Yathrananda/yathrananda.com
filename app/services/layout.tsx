...
export const metadata: Metadata = {
  title: "Travel Services - Yathrananda | Trip Planning, Booking & 24/7 Support",
  description:
  ...
  openGraph: {
    title: "Yathrananda Travel Services - Complete Travel Solutions",
    description:
    ...
    url: "https://yathrananda.com/services",
    images: [
      {
        url: "/images/services/og-services.jpg",
        width: 1200,
        height: 630,
        alt: "Yathrananda comprehensive travel services - Trip planning, booking, and support",
      },
    ],
  },
  twitter: {
