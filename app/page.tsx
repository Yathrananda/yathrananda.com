...
export default function HomePage() {
  ...
  const destinations = [
    ...
    },
    {
      ...
      date: "Fri, May 21 - Mon, Jun 10",
      price: "$670.00",
      image: "/images/tokyo-destination.jpg",
    ...
    },
    {
      ...
      date: "Fri, May 21 - Mon, Jun 10",
      price: "$670.00",
      image: "/images/chicago-destination.jpg",
    ...
    },
    {
      ...
      date: "Fri, May 21 - Mon, Jun 10",
      price: "$670.00",
      image: "/images/coxs-bazar-destination.jpg",
  ...
  const events = [
    {
      ...
      reviews: 4,
      price: "$400",
      image: "/images/adventure-tour.jpg",
    ...
    },
    {
      ...
      reviews: 8,
      price: "$320",
      image: "/images/cultural-journey.jpg",
            ...
            >
              {destinations.map((destination, index) => (
                <motion.article
                  ...
                  className="bg-card rounded-xl sm:rounded-2xl overflow-hidden shadow-lg border border-border transition-all duration-200 ease-out group hover:shadow-xl"
                  variants={fadeInUp}
                  whileHover={{ y: -8 }}
                >
          ...
          <div className="max-w-7xl mx-auto">
            <div className="flex flex-col lg:flex-row items-start lg:items-center justify-between mb-8 sm:mb-12 space-y-4 lg:space-y-0">
              ...
              <div className="flex flex-col sm:flex-row items-start sm:items-center space-y-2 sm:space-y-0 sm:space-x-4 w-full lg:w-auto">
                ...
                <motion.button
                  className="w-full sm:w-auto bg-primary text-primary-foreground px-4 sm:px-6 py-2 rounded-lg text-sm transition-all duration-200 ease-out hover:bg-primary-hover shadow-sm"
                  whileHover={{ scale: 1.05 }}
                  whileTap={{ scale: 0.95 }}
                  aria-label="Filter tour results"
                >
                  Filter Tours
                </motion.button>
              </div>
